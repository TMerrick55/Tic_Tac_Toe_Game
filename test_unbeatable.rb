...
# 	end
	...
	def test_no_win
		player = Unbeatable.new('X')
		ttt_board = ['X', '', '', '', '', '', '', '', '']
		assert_equal(1, player.get_win(ttt_board))
	end
...
# 	end
	...
	def test_no_win_O
		player = Unbeatable.new('O')
		ttt_board = ['', '', '', '', 'X', '', '', '', 'O']
		assert_equal(0, player.get_win(ttt_board))
	end
...
# 	end
	...
	def test_take_the_win
		...
		assert_equal(2, player.get_move_all_in_one(ttt_board))
	end

	def test_block_the_win
		player = Unbeatable.new('X')
		ttt_board = ['', 'X', '', '', 'X', '', 'O', '', 'O']
		assert_equal(7, player.get_move_all_in_one(ttt_board))
	end

	def test_block_the_win_2
		player = Unbeatable.new('X')
		ttt_board = ['O', '', 'X', '', '', '', '', '', 'O']
		assert_equal(4, player.get_move_all_in_one(ttt_board))
	end
...
# 	end
	...
	def test_take_corner_44
		player = Unbeatable.new('X')
		ttt_board = ['X', 'O', 'X', 'O', 'X', '', '', '', '']
		assert_equal(6, player.get_move_all_in_one(ttt_board))
	end

	def test_take_empty_side_44
		player = Unbeatable.new('X')
		ttt_board = ['X', '', 'O', '', '', '', '', '', '']
		assert_equal(1, player.get_move_all_in_one(ttt_board))
	end
end